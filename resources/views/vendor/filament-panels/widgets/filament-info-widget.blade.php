        ...
        <div class="flex items-center gap-x-3">
            <div class="flex-1">
                <a
                    ...
                    target="_blank"
                >
                    <img src="{{ asset('imgs/logoSmall.svg') }}" alt="Logo" class="img-fluid" style="max-width: 85px;">
                </a>
            ...
            <div class="flex flex-col items-end gap-y-1">
                <x-filament::link
                    color="gray"
                    href="https://docs.google.com/document/d/1avK96_hBFTkfo9c2MqvlwOhgHTqbkycg-3Xy5WP04hg/edit?usp=sharing"
                ...
                <x-filament::link
                    color="gray"
                    href="https://github.com/aleck91/SistemaTienda"
